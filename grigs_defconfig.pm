...
#   shortcut_key => 'control-mask',	# ctrl
   ...
   ui_cmp_alt_bg => '#707070',
   ui_cmp_bg => '#707070',		# CMP meter bg color
   ui_cmp_fg => '#70f070',		# CMP meter active color
   ui_cmp_font => 'Monospace',
   ui_cmp_text => '#000000',		# CMP meter text color
   ...
   ui_tmp_alt_bg => '#f07070',
   ui_tmp_bg => '#707070',		# TMP meter bg color
   ui_tmp_fg => '#70f070',		# TMP meter active color
   ui_tmp_font => 'Monospace',
   ui_tmp_text => '#000000',		# TMP meter text color
